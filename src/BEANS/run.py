def main():
    ...
    parser.add_argument("-p", "--module-path", type=Path, help="The path to the directory containing modules used.", default=Path(user_data_dir("BEANS", "Cheetah")) / "BIOMods")
    parser.add_argument("-b", "--value-size", type=int, help="The size of each value in bits.", default=16)
    parser.add_argument("-r", "--register-count", type=int, help="The amount of registers the program creates.", default=16)
    parser.add_argument("-m", "--memory-address-count", type=int, help="The amount of memory adresses the program creates.", default=64)
